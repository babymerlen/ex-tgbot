...
разработанная в 1933 году на основе гранаты Рдултовского образца 1914/30 года, использовавшейся во время Первой мировой войны.'],
                'Часы с корабля, воевавшего на Балтийском море': ['https://wampi.ru/image/RJYzZT7', 'Часы были переданы музею участниками обороны полуострова Гангут (Ханко).'],
                'Папаха Генерала Кашубы': ['https://wampi.ru/image/RJYzoRq', 'Папаха генерала танковых войск, Героя Советского Союза В.Н. Кашубы была передана школе сыном героя Б.В.Кашубой. Комсомольская организация школы с 1965 года носила имя В.Н.Кашубы.'],
                'Солдатская шинель водителя': ['https://wampi.ru/image/RJYGEV4',
                                            'Шинель водителя     "Дороги жизни" А.И. Мудрецова, в которой он две блокадные зимы вел автобус по Ладожскому озеру.'],
                'Подлинный флаг корабля, который воевал на Балтийском море': ['https://imgur.com/a/HBY1XFB',
                ...
                'Офицерский планшет Д. С. Фридмана (Зам. Командира 980 арт-полка 17-ой дивизии)': ['https://wampi.ru/image/RJY7llV', "С этим планшетом Д.С. Фридман прошел всю войну: в июле 1941 он в ушел в 17 дивизию народного ополчения Москворецкого района, в составе этой дивизии в мае 1945 встретил победу в Восточной Пруссии."],
                ...
                'Чернильница фронтового писаря': ['https://wampi.ru/image/RuqLIWP', 'Чернильница - была передана музею выпускниками - членами поискового отряда. Найдена в районе города Вязьмы.'],
                'Компас Героя Советского Союза И. Е. Качалко': ['https://wampi.ru/image/RuqPcxs', 'Компас был передан музею семьёй Героя Советского Союза И.Е. Качалко. Личная вещь героя, необходимая на фронте офицеру инженерных войск.'],
...
def menu(m, res=False):
    ...
    item1 = types.KeyboardButton("Герои Советского Союза и полные кавалеры ордена Славы")
...
def handle_text(message):
    if message.text.strip() == 'Герои Советского Союза и полные кавалеры ордена Славы':
